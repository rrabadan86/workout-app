export function UFitLogo({ className = "", width = 200, height = 240 }: { className?: string, width?: number | string, height?: number | string }) {
    return (
        <svg
            width={width}
            height={height}
        ...
        >
            ...
            <g filter="url(#shadow)" transform="translate(0, -10)">
                ...
                <path d="M 85 58 C 85 58, 81 53, 85 50 C 89 53, 85 58, 85 58 Z" fill="#ffffff" />
                <path d="M83.5 50.5A2.5 2.5 0 0 1 85 52a2.5 2.5 0 0 1 1.5-1.5A2.5 2.5 0 0 0 85 47a2.5 2.5 0 0 0-1.5 3.5z" fill="#ffffff" />
                {/* Simplified Heart for precise icon */}
            ...
            {/* Text Group */}
            <g transform="translate(100, 195)" textAnchor="middle" fontFamily="sans-serif" fontWeight="900" fontSize="56" letterSpacing="-1">
                <text x="-40" y="0" fill="#2563eb">u</text>
                <text x="30" y="0" fill="#06b6d4">Fit</text>
            </g>
        </svg>
    );
}
